from handlers import search_movie_handler, view_watchlist_handler, add_movie_handler, change_status_handler, rate_movie_handler, recommend_movie_handler, view_statistics_handler
import sys
